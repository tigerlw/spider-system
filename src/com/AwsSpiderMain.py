...
headers = {"User-Agent":"Mozilla/6.0 (Macintosh; Intel Mac OS X 10_9_5)AppleWebKit 537.36 (KHTML, like Gecko) Chrome",
...
while count < 10:
    ...
    for item in items:
        ...
        tagA = item.find("a",{"class":"a-link-normal s-access-detail-page s-color-twister-title-link a-text-normal"})
